function [P, f] = vcomodel(modelname)
...
elseif strcmpi(modelname, 'test')
    f = [logspace(log10(100), log10(1e3), 100) logspace(log10(1e3), log10(10e3), 100) logspace(log10(10e3), log10(100e3), 100) logspace(log10(100e3), log10(1e6), 100) logspace(log10(1e6), log10(10e6), 100) 10e6];
    P = 20+[-linspace(87, 114, 100) -linspace(114, 132, 100) -linspace(132, 142, 100) -linspace(142, 148, 100) -linspace(148,150, 100) -150];
else
    error('A valid VCO model name must be specified.');
end