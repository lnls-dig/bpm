...
tl = title('ABCD Linear Aproximation - \Pi/\Pi ("X")');
axis equal
...
tl = title('Real x Estimated Beam Position - \Pi/\Pi ("X")');
xl = xlabel('Real Beam Position (mm)');
yl = ylabel('Estimated Beam Position (mm)');
grid on
...
grid on
title('Inaccuracy Estimation for x - \Pi/\Pi ("X")')
ylabel('Y (mm)')
xlabel('X (mm)')
zlabel('Inaccuracy')
axis equal
...
ylabel(c,'Inaccuracy (mm)');
grid on
title('Inaccuracy Estimation for y - \Pi/\Pi ("X")')
ylabel('Y (mm)')
xlabel('X (mm)')
zlabel('Inaccuracy')
axis equal
...
grid on
tl = title('Absolute Inaccuracy Estimation - \Pi/\Pi ("X")');
yl = ylabel('Y (mm)');
xl = xlabel('X (mm)');
%set(gca,'DataAspectRatio',[10 10 1])
axis equal
...
print -depsc 2_4 % plotting figure
...
print -depsc 2_5 % plotting figure
...
ylabel(c,'Absolute Inaccuracy (mm)');
grid on
tl = title(['Inaccuracy smaller than ' num2str(err1*1e6) ' nm - \Pi/\Pi ("X")']);
yl = ylabel('Y (mm)');
xl = xlabel('X (mm)');
axis equal
...
print -depsc 2_6 % plotting figure
