...
ylabel(c,'Error (mm)');
grid on
title('Error Estimation for x - \Pi/\Pi')
ylabel('Y (mm)')
xlabel('X (mm)')
zlabel('Error')
axis equal
...
ylabel(c,'Error (mm)');
grid on
title('Error Estimation for y - \Pi/\Pi')
ylabel('Y (mm)')
xlabel('X (mm)')
zlabel('Error')
axis equal
...
grid on
title('Absolute Error Estimation - \Pi/\Pi')
ylabel('Y (mm)')
xlabel('X (mm)')
zlabel('Error')
%set(gca,'DataAspectRatio',[10 10 1])
...
ylabel(c,'Absolute Error (mm)');
grid on
title(['Error smaller than ' num2str(err1*1e6) ' nm - \Pi/\Pi'])
ylabel('Y (mm)')
xlabel('X (mm)')
zlabel('Error')
axis equal
