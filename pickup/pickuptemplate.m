...
%           'circular': 45 degrees rotated circular BPM with equidistant buttons
...
elseif  strcmpi(type, 'octogonal')
    chamber = struct(...
        ...
        'left', 10e-3, ...              % Vacuum chamber left face height [m]
        'right', 10e-3, ...             % Vacuum chamber right face height [m]
