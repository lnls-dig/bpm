...
%[Ibeam, f] = beamsignal(storagering.frf, storagering.h, storagering.bunchLength, storagering.beamCurrentSB, 1, 1500);
[Ibeam, f] = beamsignal(storagering.frf, storagering.h, storagering.bunchLength, [storagering.beamCurrent/648*ones(1,648) zeros(1,216)], 0, 1500);
%[Ibeam, f] = beamsignal(storagering.frf, storagering.h, storagering.bunchLength, [50e-3/648*ones(1,648) zeros(1,216)], 0, 1500);
%[Ibeam, f] = beamsignal(storagering.frf, storagering.h, storagering.bunchLength, [storagering.beamCurrent/648*ones(1,648) zeros(1,107) storagering.beamCurrentSB zeros(1,108)], 0, 1500);
