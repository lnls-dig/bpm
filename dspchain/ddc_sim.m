...
%% Plotting
% Compute FFTs
window = nuttallwin(length(a_mag(50:end)));
[MAF_a_mag, ff_a_mag] = fourierseries(a_mag(50:end), Ffofb, window);
[MAF_c_mag, ff_c_mag] = fourierseries(c_mag(50:end), Ffofb, window);
[MAF_a_mag_s, ff_a_mag_s] = fourierseries(a_mag_s(50:end), Ffofb, window);
[MAF_c_mag_s, ff_c_mag_s] = fourierseries(c_mag_s(50:end), Ffofb, window);
